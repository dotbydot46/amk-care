...
- Clean footer and contact cards
- Mobile/tablet/desktop responsive layout

## Key launch notes
- CRM endpoint is already connected in `script.js`.
- After uploading, test both the client enquiry form and carer application form.
- AMK should still confirm registered office address, selected Home Care areas, regulatory/CQC wording if applicable, Google Business Profile/review link, and final legal page approval.
